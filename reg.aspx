<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reg.aspx.vb" Inherits="regform.reg" %>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9 col-sm-12">
                        <div class="contents text-center">
                            ...
                            <h2 class="head-title">Registration Form</h2>
        ...
        <div class="main">
            ...
            <div class="signup-content">
                <div class="signup-img">
                    <img src="assets/img/r4.jpg" alt="" id="reg_img">
                </div>
                    ...
                    <form method="POST" class="register-form" id="register-form">
                       ...
                       <%-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pincode" id="age">
                        </div>
                        <div class="form-group">
                            <label for="course">Country :</label>
                            <div class="form-select">
                                <select name="country" id="country" style="max-height:60px;overflow: auto;">
                        ...
                        <div class="form-group">
                            <label for="pincode">PSA Membership Number :</label>
                            <input type="text" name="pincode" id="psamembership">
                        </div>
                        <div class="form-group">
                            <label for="pincode">Passport Number :</label>
                            <input type="text" name="phoneno" id="passport">
                        </div>
                        <div class="form-group">
                            <label for="pincode">Password :</label>
                            <input type="password" name="password" id="password" onkeyup='passcheck();'>
                            <span id="passcheck" style="display:none;"></span>
                        </div>
                        <div class="form-group">
                            <label for="pincode">Confirm Password :</label>
                            <input type="text" name="confirmpassword" id="confirmpassword" onkeyup='cpasscheck();'>
                            <span id='message' style="display:none;" runat="server"></span>
                        </div>
                        <div class="form-submit">
                            <input type="submit" value="Reset All" class="submit " name="reset" id="reset"/>
                            <input type="button" value="Register" class="submit register" name="submit" id="submit" onclick="psaform()"/>
